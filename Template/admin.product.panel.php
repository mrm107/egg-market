...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?php echo $conf_address . $conf_dir ?>Template/plugin/selectize/selectize.default.css">
    <link rel="stylesheet" type="text/css"
    ...
    <script type="text/javascript"
            src="<?php echo $conf_address . $conf_dir ?>Template/plugin/selectize/selectize.min.js"></script>
    <script type="text/javascript"
...
<body class="ppanelpage">
<section class="ui grid">
    <main class="sixteen wide column center-page">
        <nav id="shortcutbar">
            <a href="index.php" class="plusmenu" style="padding:0px !important;">
                <img src="<?php echo $conf_address . $conf_dir ?>Template/images/achar.64x64.v1.png"
                     class="plusmenuimage"/>
            </a>
            <div class="shortcutbar-name">سلام <?php echo $view_name ?> , وقت بخیر</div>
            <?php echo $view_menu; ?>
        </nav>
