...
$controller->view->view_title = 'شهر جدید';
$controller->checker_page_access(112);
$errors = '';
if (isset($_POST['submit'])) {
    try {

        $statement = $controller->model->db->prepare("INSERT INTO `prices_cities` (`title`, `sort`) VALUES (:title, :sort)");
...
$controller->view->view_box_header = "<span title='قیمت گذاری -> شهر جدید'>شهر جدید {$errors}</span>";
