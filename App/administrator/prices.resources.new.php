...
$controller->view->view_title = 'منبع جدید';
$controller->checker_page_access(115);
$errors = '';
if (isset($_POST['submit'])) {
    try {

        $statement = $controller->model->db->prepare("INSERT INTO `prices_resources` (`title`, `description`, `sort`) VALUES (:title, :description, :sort)");
...
$controller->view->view_box_header = "<span title='قیمت گذاری -> منبع جدید'>منبع جدید {$errors}</span>";
$controller->view_content_beta .= "
	<div class='content-place-full' id='scroll-place'>
		...
		<div class='form-elements'>
            ...
            <div>
			    <h6>اولویت</h6>
			    <input type='number' step='1' value='0' name='sort' required>    
            </div>	
