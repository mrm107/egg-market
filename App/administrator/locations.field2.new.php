...
$controller->view->view_title = 'مورد پیشنهادی جدید';
$controller->checker_page_access(95);
$errors = '';
if (isset($_POST['submit'])) {
    try {

        $statement = $controller->model->db->prepare("INSERT INTO `locations_field2` (`title`, `province`) VALUES (:title, :province)");
...
$controller->view->view_box_header = "<span title='مکان ها -> مورد پیشنهادی جدید'>مورد پیشنهادی جدید {$errors}</span>";
